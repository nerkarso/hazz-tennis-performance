...
export default function ErrorStateView({ children, className, fullHeight, fullScreen, inline, title }) {
  return (
    <div
      ...
      <div className={cx('flex items-center gap-3 p-4 text-center', { 'flex-col max-w-sm': !inline })}>
        <ExclamationCircleIcon className="flex-shrink-0 w-10 h-10 text-red-600 dark:text-red-500" />
