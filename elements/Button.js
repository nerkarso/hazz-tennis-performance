...
function Button({ children, className, color, component: Component = 'button', icon: Icon, size, variant, ...props }, ref) {
  return (
    <Component
      ref={ref}
      className={cx(
        'inline-flex items-center justify-center flex-shrink-0 px-2 rounded-md font-medium transition duration-150 focus:outline-none',
        {
