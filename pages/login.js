function Login() {
  return (
    <div
      ...
      style={{
        backgroundImage:
          'url("https://images.unsplash.com/photo-1542446655-53a7e25c8fe2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=895&q=80")',
      }}>
      <div className="w-full">
        <div className="flex mx-auto overflow-hidden bg-white rounded-lg shadow dark:bg-base-800 lg:max-w-md">
          <div className="w-full px-6 py-8 md:px-8">
            ...
            <p className="text-xl text-center text-base-600 dark:text-base-200">Welcome back</p>
            <div className="mt-4">
            ...
            <div className="flex items-center justify-between mt-4">
              ...
              <a href="/signup" className="text-xs text-base-500 uppercase dark:text-base-400 hover:underline">
                or sign up
              </a>
              <span className="w-1/5 border-b dark:border-base-600 md:w-1/4" />
            </div>
