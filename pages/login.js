        ...
        <div className="flex flex-col overflow-y-auto md:flex-row">
          ...
          <div className="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            <div className="w-full">
              ...
              <h1 className="mb-4 text-2xl font-semibold text-base-700 dark:text-base-200">Welcome back</h1>
              ...
              <hr className="my-6" />
              <p>
                <a className="text-sm font-medium text-primary-600 dark:text-primary-400 hover:underline" href="/forgot-password">
                  Forgot your password?
                </a>
              </p>
              <p className="mt-1">
                <a className="text-sm font-medium text-primary-600 dark:text-primary-400 hover:underline" href="/signup">
                  Create account
                </a>
              </p>
            </div>
