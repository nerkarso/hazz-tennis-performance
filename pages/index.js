      ...
      <div className="py-16 overflow-hidden bg-base-50 md:py-20 lg:py-24">
        <div className="relative max-w-xl px-4 mx-auto sm:px-6 lg:px-8 lg:max-w-7xl">
          ...
          <div className="relative">
            <h3 className="text-3xl font-extrabold leading-8 tracking-tight text-center text-base-900 sm:text-4xl">A better way to learn tennis</h3>
          ...
          <div className="relative mt-12 lg:mt-20 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
            <div className="relative">
              ...
              <p className="mt-3 text-lg text-base-500">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur minima sequi recusandae, porro maiores officia assumenda aliquam laborum ab aliquid veritatis impedit odit adipisci
      ...
      <div className="bg-primary-900">
        <div className="px-4 py-12 mx-auto max-w-7xl sm:py-16 sm:px-6 lg:px-8 lg:py-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="mt-3 text-xl text-primary-100 sm:mt-4">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Repellendus repellat laudantium.</p>
          </div>
        ...
        <div className="px-4 py-12 mx-auto max-w-7xl sm:px-6 md:py-16 lg:px-8 lg:py-20">
          ...
          <div className="flex mt-8">
            <div className="inline-flex rounded-md shadow">
              <a href="/login" className="inline-flex items-center justify-center px-5 py-3 text-lg font-medium text-white rounded-lg bg-primary-600 hover:bg-primary-500 focus:outline-none">
                Log in
              </a>
            </div>
      ...
      <div className="bg-white border-base-200">
        <div className="px-4 py-12 mx-auto max-w-7xl sm:px-6 lg:py-16 lg:px-8">
          <div className="pt-8 border-t border-base-200">
            <p className="text-base text-base-400 xl:text-center">&copy; 2021 Hazz Tennis Performance. All rights reserved.</p>
          </div>
        </div>
      </div>
    </>
